...
/*Запрос Ответ*/
function sendForm(Form, [formCall, formPopup, thx]) {
...
/*//////////////*/
/*questions*/
const questionItem = document.querySelectorAll(".questions_body_left_item");
const questionItemTop = document.querySelectorAll(".questions_body_left_item_top");
questionItem.forEach((elem, index) => {
    elem.addEventListener("click", () => {
        elem.classList.toggle("active")
        questionItemTop[index].classList.toggle("active")
    })
})
/*//////*/
/*about slider*/
